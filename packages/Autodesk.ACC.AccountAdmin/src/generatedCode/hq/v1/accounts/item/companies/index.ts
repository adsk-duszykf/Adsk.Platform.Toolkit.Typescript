...
// @ts-ignore
import { type WithCompany_ItemRequestBuilder, WithCompany_ItemRequestBuilderNavigationMetadata, WithCompany_ItemRequestBuilderRequestsMetadata } from './item/index.js';
// @ts-ignore
...
export interface CompaniesRequestBuilder extends BaseRequestBuilder<CompaniesRequestBuilder> {
    ...
    /**
     * Gets an item from the Autodesk.ACC.AccountAdmin.hq.v1.accounts.item.companies.item collection
     * @param company_id Company ID
     * @returns {WithCompany_ItemRequestBuilder}
     */
     byCompany_id(company_id: Guid) : WithCompany_ItemRequestBuilder;
    /**
 ...
 */
export const CompaniesRequestBuilderUriTemplate = "{+baseurl}/hq/v1/accounts/{account_id}/companies{?field*,limit*,offset*,sort*}";
/**
 * | Country for this company|| Refer to the ``country`` list in the `Parameters </en/docs/bim360/v1/overview/parameters>`_ guide.
 */
...
export const CompaniesRequestBuilderNavigationMetadata: Record<Exclude<keyof CompaniesRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    byCompany_id: {
        requestsMetadata: WithCompany_ItemRequestBuilderRequestsMetadata,
        navigationMetadata: WithCompany_ItemRequestBuilderNavigationMetadata,
        pathParametersMappings: ["company_id"],
    },
    importEscaped: {
