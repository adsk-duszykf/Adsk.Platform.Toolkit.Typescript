...
// @ts-ignore
import { ConstructionRequestBuilderNavigationMetadata, type ConstructionRequestBuilder } from './construction/index.js';
// @ts-ignore
import { HqRequestBuilderNavigationMetadata, type HqRequestBuilder } from './hq/index.js';
// @ts-ignore
 ...
 */
export interface BaseAccountAdminClient extends BaseRequestBuilder<BaseAccountAdminClient> {
    /**
     * The construction property
     */
    get construction(): ConstructionRequestBuilder;
    /**
     * The hq property
     */
    get hq(): HqRequestBuilder;
}
/**
 * Instantiates a new {@link BaseAccountAdminClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createBaseAccountAdminClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<BaseAccountAdminClient>(requestAdapter, pathParameters, BaseAccountAdminClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const BaseAccountAdminClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const BaseAccountAdminClientNavigationMetadata: Record<Exclude<keyof BaseAccountAdminClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    construction: {
        navigationMetadata: ConstructionRequestBuilderNavigationMetadata,
    },
    hq: {
        navigationMetadata: HqRequestBuilderNavigationMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
