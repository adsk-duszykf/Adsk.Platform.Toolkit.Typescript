import { AuthenticationScope, AuthTokenExtended } from "./authenticationClientHelper.js";
 ...
 */
export function createAuthorizationString(clientId: string, clientSecret: string): string {
...
export function   createAuthenticationUrl(
  ...
  export function createPKCEAuthenticationUrl(
    ...
    let url = createAuthenticationUrl(clientId, redirectUri, scope, nonce, state, forceLogin);
