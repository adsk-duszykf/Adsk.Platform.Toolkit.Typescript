...
// @ts-ignore
import { createErrorResponseFromDiscriminatorValue, createFolderCollectionFromDiscriminatorValue, type ErrorResponse, type FolderCollection } from '../../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /vaults/{-id}/folders/{id}/sub-folders
 */
export interface SubFoldersRequestBuilder extends BaseRequestBuilder<SubFoldersRequestBuilder> {
    /**
     * Get the immediate subfolders of a given folder Id
     ...
     */
     get(requestConfiguration?: RequestConfiguration<SubFoldersRequestBuilderGetQueryParameters> | undefined) : Promise<FolderCollection | undefined>;
    /**
     * Get the immediate subfolders of a given folder Id
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {RequestInformation}
     */
     toGetRequestInformation(requestConfiguration?: RequestConfiguration<SubFoldersRequestBuilderGetQueryParameters> | undefined) : RequestInformation;
}
/**
 * Get the immediate subfolders of a given folder Id
 */
export interface SubFoldersRequestBuilderGetQueryParameters {
    /**
 ...
 */
export const SubFoldersRequestBuilderUriTemplate = "{+baseurl}/vaults/{%2Did}/folders/{id}/sub-folders{?cursorState*,limit*,option%5BextendedModels%5D*,option%5BpropDefIds%5D*}";
/**
 * Mapper for query parameters from symbol name to serialization name represented as a constant.
 */
const SubFoldersRequestBuilderGetQueryParametersMapper: Record<string, string> = {
 ...
 */
export const SubFoldersRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: SubFoldersRequestBuilderUriTemplate,
        ...
        responseBodyFactory:  createFolderCollectionFromDiscriminatorValue,
        queryParametersMapper: SubFoldersRequestBuilderGetQueryParametersMapper,
    },
};
/* tslint:enable */
/* eslint-enable */
