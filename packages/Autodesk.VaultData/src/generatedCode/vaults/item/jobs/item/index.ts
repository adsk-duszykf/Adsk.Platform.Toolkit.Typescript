...
// @ts-ignore
import { createErrorResponseFromDiscriminatorValue, createJobFromDiscriminatorValue, type ErrorResponse, type Job } from '../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /vaults/{-id}/jobs/{id}
 */
 ...
 */
export const JobsItemRequestBuilderUriTemplate = "{+baseurl}/vaults/{%2Did}/jobs/{id}";
/**
