 ...
 */
export const ChangeOrdersRequestBuilderUriTemplate = "{+baseurl}/vaults/{%2Did}/items/{id}/change-orders{?cursorState*,limit*,option%5BextendedModels%5D*,option%5BincludeClosedECOs%5D*,option%5BpropDefIds%5D*}";
/**
