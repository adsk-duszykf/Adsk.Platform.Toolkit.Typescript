...
/**
 * Builds and executes requests for operations under /vaults/{-id}/file-versions/{id}/thumbnail
 */
export interface ThumbnailRequestBuilder extends BaseRequestBuilder<ThumbnailRequestBuilder> {
    /**
     * Get thumbnail for given file version Id
 ...
 */
export const ThumbnailRequestBuilderUriTemplate = "{+baseurl}/vaults/{%2Did}/file-versions/{id}/thumbnail";
/**
