...
/**
 * Builds and executes requests for operations under /vaults/{-id}/file-versions/{id}/parents
 */
export interface ParentsRequestBuilder extends BaseRequestBuilder<ParentsRequestBuilder> {
    /**
     * Get parent associations for given file version id.
     ...
     */
     get(requestConfiguration?: RequestConfiguration<ParentsRequestBuilderGetQueryParameters> | undefined) : Promise<FileAssocCollection | undefined>;
    /**
     * Get parent associations for given file version id.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
...
export interface ParentsRequestBuilderGetQueryParameters {
    ...
    /**
     * ``true``: Include all levels of parents.``false``: (Default) Include only the direct parents.
     */
 ...
 */
export const ParentsRequestBuilderUriTemplate = "{+baseurl}/vaults/{%2Did}/file-versions/{id}/parents{?cursorState*,limit*,option%5BextendedModels%5D*,option%5BgetLatestAssocs%5D*,option%5BincludeHidden%5D*,option%5BpropDefIds%5D*,option%5Brecurse%5D*,option%5BreleaseBiased%5D*,option%5BreleasedOnly%5D*}";
/**
